...
namespace TimesheetManagement.Business.Tasks.Managers
{
    public class TaskActivityManager : IManager<TaskActivity, int>
    {
        ...
        public TaskActivity Add(TaskActivity taskActivity)
        {
            TaskActivityDTO taskActivityDto = TasksBoMapper.CreateTaskActivityDto(taskActivity);

            taskActivityDto = taskActivityRepository.Add(taskActivityDto);
        ...
        public bool Update(TaskActivity taskActivity)
        {
            TaskActivityDTO taskActivityDto = TasksBoMapper.CreateTaskActivityDto(taskActivity);

            return taskActivityRepository.Update(taskActivityDto);
        }
